...
namespace SamplesHR.Seeder;

internal sealed class SampleDataSeeder(IDocumentStore store, ILogger<SampleDataSeeder> logger)
{
    ...
    private static async Task SeedDepartments(IAsyncDocumentSession session)
    {
    ...
    private static async Task SeedEmployees(IAsyncDocumentSession session)
    {
    ...
    private static async Task SeedHRPolicies(IAsyncDocumentSession session)
    {
...
Any suspected or confirmed data breach must be reported immediately to the Data Protection Officer and may require notification to regulatory authorities and affected individuals within specified timeframes. The company maintains procedures for responding to individual requests regarding their personal data, including access requests, correction requests, and deletion requests. Employees must cooperate with privacy compliance efforts and report any concerns about data handling practices. Regular privacy training and awareness programs ensure ongoing compliance with evolving privacy requirements."
    ...
    private static async Task SeedVacationRequests(IAsyncDocumentSession session)
    {
        var today = DateTime.UtcNow.Date;
    ...
    private static async Task SeedPayStubs(IAsyncDocumentSession session)
    {
        var employees = new[]
        {
            new { Id = "alice",  Name = "Alice Johnson",   MonthlySalary = 8333.33m, BankName = "Wells Fargo",     RoutingNumber = "121000248", AccountNumber = "****4567" },
            new { Id = "bob",    Name = "Bob Smith",       MonthlySalary = 7500.00m, BankName = "Chase Bank",      RoutingNumber = "021000021", AccountNumber = "****8901" },
            new { Id = "carol",  Name = "Carol Wilson",    MonthlySalary = 7000.00m, BankName = "Bank of America", RoutingNumber = "026009593", AccountNumber = "****2345" },
            new { Id = "david",  Name = "David Brown",     MonthlySalary = 6500.00m, BankName = "US Bank",         RoutingNumber = "091000019", AccountNumber = "****6789" },
            new { Id = "john",   Name = "John Dev",        MonthlySalary = 7500.00m, BankName = "Capital One",     RoutingNumber = "051405515", AccountNumber = "****1234" },
            new { Id = "sarah",  Name = "Sarah Martinez",  MonthlySalary = 6000.00m, BankName = "TD Bank",         RoutingNumber = "211274450", AccountNumber = "****5678" },
            new { Id = "mike",   Name = "Mike Thompson",   MonthlySalary = 4500.00m, BankName = "PNC Bank",        RoutingNumber = "043000096", AccountNumber = "****9012" }
        };
    ...
    private static async Task SeedHRIssues(IAsyncDocumentSession session)
    {
        var today = DateTime.UtcNow.Date;
    ...
    private static async Task SeedSignatureDocuments(IAsyncDocumentSession session)
    {
        var today = DateTime.UtcNow.Date;
